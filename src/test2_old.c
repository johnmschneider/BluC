...
struct ParamlessConstructorTest
{
...
void oxyC_class_ParamlessConstructorTest_this(struct ParamlessConstructorTest *this)
    {
...
int main(void)
{
    ...
    struct ParamlessConstructorTest test4;
    oxyC_class_ParamlessConstructorTest_this(&test4);
 oxyC_class_String_tilde_this(&test2); oxyC_class_String_tilde_this(&error);}
